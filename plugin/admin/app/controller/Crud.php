...
class Crud extends Base
{
    ...
    {
        $field = $request->get('field',$this->model->getKeyName());
...
//
//            if ($value === '' || !isset($allow_column[$column]) || is_array($value) && (empty($value) || !in_array($value[0], ['null', 'not null']) && !isset($value[1]))) {
//                unset($where[$column]);
//            }
//        }
